                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex items-center">
                                    <x-input id="" class="block mr-1" type="radio" name="league_type" :value="1" />
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex items-center">
                                    <x-input id="market_type" class="block mr-1" type="radio" name="market_type" :value="1" />
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex items-center">
                                    <x-input id="" class="block mr-1" type="radio" name="score_type" :value="1" />
